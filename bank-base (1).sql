...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 17 2024 г., 07:21
...
CREATE TABLE `cheta` (
  ...
  `Valuta` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Валюта (рубли, евро)'
...
--
ALTER TABLE `cheta`
  MODIFY `Id_nomer` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Номер счета', AUTO_INCREMENT=24;
